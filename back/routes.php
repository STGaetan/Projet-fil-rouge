...
return [
    ...
    ['GET',    '/api/formations/{id}/stagiaires',    'FormationController@stagiaires'],
    ...
    // Retards
    ['GET',    '/api/retards',      'RetardController@index'],
    ['GET',    '/api/retards/{id}', 'RetardController@show'],
    ['POST',   '/api/retards',      'RetardController@store'],
    ['PUT',    '/api/retards/{id}', 'RetardController@update'],
    ['DELETE', '/api/retards/{id}', 'RetardController@destroy'],

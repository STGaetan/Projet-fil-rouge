...
const initialFolders = [
  {
    id: "1",
    title: "Dossier Inscription 2026",
    student: "Marie Curie",
    type: "Inscription",
    date: "12 Mar 2026",
    status: "Complet",
...
export function Dossiers() {
  ...
  const handleSave = (e: React.FormEvent) => {
    ...
    if (!currentFolder?.student?.trim()) {
      toast.error("Le nom du stagiaire est obligatoire.");
      return;
    }
    if (currentFolder.id) {
      setFolders(
        folders.map((f) =>
          f.id === currentFolder.id
            ? { ...currentFolder, date: "Aujourd'hui" }
            : f,
        ),
      );
      ...
      setFolders([
        { ...currentFolder, id: Math.random().toString(), date: "Aujourd'hui" },
        ...folders,
      ]);
      ...
      <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4">
        <div className="flex flex-col sm:flex-row w-full lg:w-auto gap-4">
          ...
          <div className="flex bg-white rounded-lg p-1 border border-gray-200 shadow-sm overflow-x-auto w-full sm:w-auto shrink-0">
            {["Tous", "Complet", "En attente", "Incomplet", "Refusé"].map(
              (status) => (
                <button
                  key={status}
          ...
          >
            <div className="flex justify-between items-start mb-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h3 className="font-bold text-[#1A1F3D] text-sm line-clamp-2 leading-tight mb-1">
                    {folder.title}
                  </h3>
              ...
              <div className="flex gap-1 sm:opacity-0 sm:group-hover:opacity-100 transition-opacity">
                <button
                  ...
                  className="p-1.5 text-gray-400 hover:text-[#1A1F3D] hover:bg-gray-100 rounded-md transition-colors"
                  title="Modifier"
                >
                  <Edit size={14} />
                </button>
            ...
            <div className="space-y-3 flex-1">
              ...
              <div className="flex justify-between items-center text-sm pt-2 border-t border-gray-100/50">
                ...
                <StatusBadge
                  status={
                    folder.status === "Complet" ? "Validé" : folder.status
                  }
                />
              </div>
            </div>
            ...
            <div className="mt-5 grid grid-cols-2 gap-2">
              ...
              {folder.status !== "Complet" ? (
                ...
                <button className="flex items-center justify-center gap-1.5 px-3 py-2 bg-green-50 text-green-600 border border-green-200 rounded-lg text-xs font-semibold shadow-sm cursor-default">
      ...
      {filteredFolders.length === 0 && (
        <div className="text-center py-20 bg-white rounded-xl border border-gray-200 shadow-sm animate-in zoom-in-95">
          ...
          <p className="text-gray-500 font-medium">
            Aucun dossier trouvé pour cette recherche ou ce filtre.
          </p>
        </div>
      )}
        ...
        <form onSubmit={handleSave} className="space-y-4">
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                setCurrentFolder({ ...currentFolder, title: e.target.value })
              }
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                setCurrentFolder({ ...currentFolder, student: e.target.value })
              }
              className="w-full bg-gray-50 border border-gray-200 rounded-lg px-3 py-2.5 text-sm focus:ring-2 focus:ring-[#FF6600]/20 focus:border-[#FF6600] outline-none transition-all"
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <select
                ...
                onChange={(e) =>
                  setCurrentFolder({ ...currentFolder, type: e.target.value })
                }
                className="w-full bg-gray-50 border border-gray-200 rounded-lg px-3 py-2.5 text-sm focus:ring-2 focus:ring-[#FF6600]/20 focus:border-[#FF6600] outline-none transition-all"
              >
            ...
            <div>
              ...
              <select
                ...
                onChange={(e) =>
                  setCurrentFolder({ ...currentFolder, status: e.target.value })
                }
                className="w-full bg-gray-50 border border-gray-200 rounded-lg px-3 py-2.5 text-sm focus:ring-2 focus:ring-[#FF6600]/20 focus:border-[#FF6600] outline-none transition-all"
              >
      ...
      >
        <div className="mb-6">
          <p className="text-gray-600 text-sm">
            ...
            appartenant à {currentFolder?.student} ?
          </p>
        </div>

    ...
    <div className="flex h-[100dvh] w-full bg-[#F5F5F5] font-sans overflow-hidden text-[#1A1F3D]">
      ...
      `}>
        <div className="w-full h-[70px] lg:h-[80px] flex items-center justify-between px-6 lg:justify-center border-b border-white/10 shrink-0">
          <div className="text-2xl lg:text-3xl font-bold tracking-wider text-white flex items-center gap-1">
            <span className="text-[#FF6600]">M</span>NS<span className="text-sm font-normal text-gray-400 ml-2 hidden lg:inline">Admin</span>
          </div>
          <button 
          ...
          <nav className="flex flex-col gap-1.5">
            {navItems.map((item) => (
              <NavLink
                ...
                onClick={() => setIsMobileMenuOpen(false)}
                className={({ isActive }) => `flex items-center gap-3 px-3 py-3 lg:py-2.5 rounded-lg text-base lg:text-sm font-medium transition-colors ${
                  isActive 
                ...
                <>
                  ...
                  <div className="absolute right-0 mt-2 w-80 sm:w-96 bg-white rounded-xl shadow-xl border border-gray-100 z-50 animate-in fade-in zoom-in-95 overflow-hidden">
                    <div className="px-4 py-3 border-b border-gray-100 flex justify-between items-center bg-gray-50/80">
                      ...
                      <button className="text-xs text-[#FF6600] font-semibold hover:underline">Tout marquer comme lu</button>
                    </div>
            ...
            <div className="relative">
              ...
              >
                <div className="text-right hidden sm:block">
                  <p className="text-sm font-bold text-[#1A1F3D] leading-none">Admin Syst.</p>
                  <p className="text-xs text-gray-500 mt-1 truncate max-w-[100px]">{userEmail}</p>
                </div>
                <ImageWithFallback 
                ...
                <>
                  ...
                  <div className="absolute right-0 mt-2 min-w-[200px] bg-white rounded-xl shadow-lg border border-gray-100 p-1.5 z-50 animate-in fade-in zoom-in-95">
                    <div className="px-3 py-2 sm:hidden border-b border-gray-100 mb-1.5">
                      <p className="text-sm font-bold text-[#1A1F3D]">{userEmail}</p>
